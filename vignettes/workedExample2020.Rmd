...
```{r includeplots1, eval = T, echo = F, out.width='50%', fig.alt="Gulf of Maine"}
...
```{r plotspeciescomp, echo = F, eval = T, out.width='80%',fig.alt="Gulf of Maine species composition"}
